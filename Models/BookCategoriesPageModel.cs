...
namespace Cancel_Nicole_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Cancel_Nicole_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Cancel_Nicole_Lab2Context context,
